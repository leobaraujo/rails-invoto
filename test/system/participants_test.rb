...
class ParticipantsTest < ApplicationSystemTestCase
  ...
  test "should create participant" do
    ...
    fill_in "Cpf", with: @participant.cpf
    fill_in "Microregion", with: @participant.microregion_id
    fill_in "Name", with: @participant.name
    fill_in "Photo url", with: @participant.photo_url
    fill_in "Region", with: @participant.region_id
